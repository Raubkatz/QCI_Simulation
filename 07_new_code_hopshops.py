...
# ============================================================
# Config (kept; Austria overrides must come from THIS config)
# ============================================================
...
# ============================================================
# Degree-constrained edge construction (IMPROVED SIM LOGIC)
# ============================================================
...
# ============================================================
# Graph, exports, hop stats (kept except TRN logic)
# ============================================================
...
def plot_simulation(
    ...
    for _, row in edges_df.iterrows():
        ax.plot([row["u_lon"], row["v_lon"]], [row["u_lat"], row["v_lat"]], linewidth=0.6, alpha=0.5, zorder=3)
...
# ============================================================
# Monte Carlo and reporting (kept)
# ============================================================
...
def main() -> None:
    ...
    out_root = Path("EUMS_results_islands_new_all_together2303_fghgfh_short")
